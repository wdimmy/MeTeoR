...
output_file_handler = logging.FileHandler("./log/naive.log")
...
start_time = time.time()
materialize(D, rules=program, D_index=D_index, K=1000, logger=logger)
logger.info("Iteration={}, Naive method time: {}s".format(30, time.time() - start_time))
print_dataset(D)