...
output_file_handler = logging.FileHandler("./log/seminaive.log")
...
start_time = time.time()
materialize(D, rules=program, D_index=D_index, seminaive=True, delta_old=D, K=1000, logger=logger)
logger.info("Iteration={}, Seminaive method time: {}s".format(30, time.time() - start_time))
print_dataset(D)